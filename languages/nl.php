...
%s',
  ...
  'groups:edit:reason' => 'Goedkeuring reden',
...
om een groep te maken op basis van deze tool set. Dit zal ook de tool selectie op het formulier verbergen.',
  ...
  'group_tools:suggested:remove' => 'Verwijder de groep uit de voorgestelde lijst',
...
%s',
  ...
  'groups:tool:mail_members' => 'Mogen groepsleden andere leden een e-mail sturen',
  'groups:tool:mail_members:description' => 'Dit maakt het mogelijk dat gewone groepsleden een e-mail kunnen versturen aan de andere leden. Standaard is dit voorbehouden aan de groep beheerders.',
...
%s',
  ...
  'group_tools:csv_exporter:group_admin:email' => 'Groepsbeheerder(s) e-mailadres',
  ...
  'group_tools:notifications:toggle:site:enabled' => 'Op dit moment ontvang je notificaties over activiteit in deze groep',
  'group_tools:notifications:toggle:site:enabled:link' => 'Notificaties uitschakelen',
  'group_tools:notifications:toggle:site:disabled' => 'Op dit moment ontvang je geen notificaties over activiteit in deze groep',
...
%s',
  ...
  'widgets:group_members:name' => 'Groepsleden',
  'widgets:group_members:description' => 'Toont de leden van de huidige groep',
  'widgets:group_members:view:no_members' => 'Geen groepsleden gevonden',
...
In de eerste kolom moeten de e-mailadressen van de nieuwe leden staan. Er mag geen kopregel zijn.',
