...
%s',
  ...
  'group_tools:notifications:toggle:site:enabled' => 'Actualmente tu estás recibiendo las notificaciones de la actividad en este grupo',
  'group_tools:notifications:toggle:site:enabled:link' => 'Desactivar notificaciones',
  'group_tools:notifications:toggle:site:disabled' => 'Actualmente tu no estás recibiendo las notificaciones de la actividad en este grupo',
  'group_tools:notifications:toggle:site:disabled:link' => 'Activar notificaciones',
  'groups:tool:mail_members' => 'Permitir a los miembros del grupo escribir correos a otros miembros',
  'groups:tool:mail_members:description' => 'Esto permitirá a los miembros normales del grupo enviar un correo electrónico a otros miembros. Por defecto esta función está limitada a administradores de grupo.',
